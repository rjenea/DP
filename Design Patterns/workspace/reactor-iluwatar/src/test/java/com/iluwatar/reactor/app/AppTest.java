...
/**
 * 
 * This class tests the Distributed Logging service by starting a Reactor and
 * then sending it concurrent logging requests using multiple clients.
 */
public class AppTest {
	 ...
	 *             if interrupted while stopping the application.
	 */
	@Test
